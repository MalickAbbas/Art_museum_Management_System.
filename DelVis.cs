...
{
    public partial class DelVis : Form
    {
        public DelVis()
        {
            InitializeComponent();
        ...
        private void DelVis_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand commands = new SqlCommand("delete from Visitor where Name=@Name");
